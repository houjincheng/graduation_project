 ...
 *
 * $Id: SessionFrameMapper.java 662 2002-11-02 07:25:59Z nfiedler $
 *
 ********************************************************************/
...
public class SessionFrameMapper {
     ...
     */
    public static void addFrameSessionMapping(Frame f, Session s) {
    ...
    public static Session getSessionForEvent(EventObject e) {
    	...
    	Frame owningFrame = getOwningFrame(e);
        return getSessionForFrame(owningFrame);
    } // getSessionForEvent
     ...
     */
    public static void removeFrameSessionMapping(Frame f) {
