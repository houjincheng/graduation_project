...
public interface Session {
   ...
   void init(ConsoleCenter center);
   /**
   ...
   /**
    * 下面这个方法是在进行左部面板移植时添加的。2013年5月18日20:17:15
    * @param prj
    * @param session
    */
    void initPath(Project prj, Session session);
    
    void addManager(Class classname, BreakpointManager bkm);
