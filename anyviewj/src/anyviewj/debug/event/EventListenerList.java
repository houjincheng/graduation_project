...
/**
 * Class EventListenerList is much like the same-named class in the Sun
 * JFC package. It is a trivial implementation backed by an instance of
 * <code>java.util.ArrayList</code>.
 *
 * <p>Many of these methods are not synchronized and so care should be
 * exercised.</p>
 *
 * @author  ltt
 */
public class EventListenerList {
    /** Event listener list. The odd-numbered entries are the listener
     * types and the even-numbered entries are the listeners
     * instances. */
     ...
     *
     * @param  t  class for which to get listener count.
     ...
     * ListenerType-listener pairs. This method is guaranteed to pass
     * back a non-null array, so that no null-checking is required in
     * fire methods. A zero-length array of Object should be returned if
     * there are currently no listeners.
     *
     * @return  listener list as an array.
     */
     ...
     *
     * @param  t  class for which to get listeners.
