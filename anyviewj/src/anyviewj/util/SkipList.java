 ...
 *                              iterator.
 *      nf      11/01/02        Moved to jswat util package
 *
 * $Id: SkipList.java 826 2003-01-29 08:07:47Z nfiedler $
 *
 ********************************************************************/
...
public class SkipList implements Set {
    ...
    public SkipList(double probability, int maxLevel) {
        ...
        // Allocate tailElement with a key greater than any valid key;
        // all levels of skip lists terminate on tailElement.
	...
	public void clear() {
        ...
        listLevel = 1;
        // All forward pointers of list's header point to tailElement.
	...
	public boolean contains(Object o) {
        ...
        while (!found && x.forward(0) != tailElement) {
            if (x.getObject() == o || x.getObject() != null
                && x.getObject().equals(o)) {
                found = true;
                break;
            }
            x = x.forward(0);
    ...
    public boolean delete(int searchKey) {
        ...
        if (x.getKey() == searchKey) {
            ...
            //       list->header->forward[list->level] = tailElement do
            while (listLevel > 0
                && listHeader.forward(listLevel) == tailElement) {
