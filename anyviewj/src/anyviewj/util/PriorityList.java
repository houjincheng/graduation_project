 ...
 *
 * $Id: PriorityList.java 826 2003-01-29 08:07:47Z nfiedler $
 *
 *******************************************************************/
...
public class PriorityList implements Cloneable, List {
	...
	public boolean remove(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            Entry entry = (Entry) sortedList.get(i);
            if (entry.getObject().equals(element)) {
                sortedList.remove(i);
                return true;
            }
        }
	...
	public Object set(int index, Object element) {
        ...
        sortedList.set(index, new Entry(n.getPriority(), element));
        return n.getObject();
    } // set
    ...
    protected class Entry {
        ...
        /**
         * Return this entry's element.
         *
         * @return  element stored in this entry.
         */
    ...
    protected class Iter implements Iterator {
        ...
        @Override
		public Object next() {
            return ((Entry) iter.next()).getObject();
        } // next
    ...
    protected class ListIter extends Iter implements ListIterator {
		...
		public Object previous() {
            return ((Entry) liter.previous()).getObject();
        } // previous
