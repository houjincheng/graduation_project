 ...
 *
 * $Id: HighlightDrawLayer.java 1108 2004-01-22 09:08:38Z nfiedler $
 *
 ********************************************************************/
...
public abstract class HighlightDrawLayer extends AbstractDrawLayer {
	...
	public int updateContext(DrawContext ctx, int offset) {
    	...
    	//System.out.println("highlightStart = "+highlightStart);
    	//System.out.println("highlightEnd = "+highlightEnd);
