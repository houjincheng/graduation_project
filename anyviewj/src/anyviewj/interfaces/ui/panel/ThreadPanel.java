 ...
 *
 * $Id: ThreadPanel.java 1813 2005-07-17 05:55:46Z nfiedler $
 *
 ********************************************************************/

package anyviewj.interfaces.ui.panel;

import anyviewj.interfaces.ui.panel.TreeTableModel;
...
import anyviewj.interfaces.ui.SmartPopupMenu;
import anyviewj.util.Threads;
...
public class ThreadPanel extends AbstractPanel
    ...
    protected void rebuildTree() {
        ...
        if (threadRef != null) {
            MutableTreeNode node = model.findNodeFast(threadRef);
            if (node != null) {
