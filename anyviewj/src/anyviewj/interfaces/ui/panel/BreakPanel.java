...
//import anyviewj.debug.actions.AddBreakGroupAction;
import anyviewj.debug.actions.SetBreakAction;
...
public class BreakPanel extends AbstractPanel
	...
	public void breakpointAdded(BreakpointEvent e) {
    	if ( e.getBreakpoint() instanceof UndrawBreakpoint )
    	{
    		return;
    	}
        refreshLater();
    ...
    protected JComponent buildUI(JComponent tree) {
        ...
        try {        	
            button.addActionListener(new SetBreakAction());
        } catch (Exception e) {
        ...
        //try {
            //button.addActionListener(new AddBreakGroupAction());
        //} catch (Exception e) {
        //    button.setEnabled(false);
        //}
        //gbl.setConstraints(button, gbc);
...
//                                  MutableTreeNode node) {
    protected void buildGroupNode(BreakpointGroup brkgrp,Hashtable bpht,
          MutableTreeNode node) {
        ...
        while (iter.hasNext()) {
            ...
            buildGroupNode(subgroup, bpht, subnode);
        }
//
...
//        }
        ...
        for(Object key:x)
        {
        	 Breakpoint bp = (Breakpoint)bpht.get(key);
	...
	public void refresh(Session session) {
        ...
        try {
            ...
            buildGroupNode(group, brkman.breakpointsTable,groupNode);
    ...
    protected class GroupNode extends BasicTreeNode {
         ...
         */
        public GroupNode(BreakpointGroup bpg) {
            super(bpg);
        }
